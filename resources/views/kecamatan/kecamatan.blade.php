...
<x-layout bodyClass="g-sidenav-show  bg-gray-200">
                                        ...
                                        <div class="modal-body p-0">
                                            <div class="card card-plain">
                                                <div class="card-header pb-0 text-left">
                                                    <h5 class="">Tambah Kecamatan Baru</h5>
                                                ...
                                                <div class="card-body pb-3">
                                                    <form role="form text-left">
                                                        <div class="input-group input-group-outline my-3">
                                                            ...
                                                            <input type="text" name="nama_kecamatan" id="nama_kecamatan" class="form-control" required autofocus>
                                                        </div>
                                                        <div class="input-group input-group-outline my-3">
                                                        ...
                                                        <div class="text-right">
                                                            <button type="button" id="simpan-kecamatan" class="btn bg-gradient-primary">Simpan</button>
                            ...
                            <div class="card">
                                <div class="card-header pb-1">
                                    ...
                                    <div class="col-12 text-end pt-0 pb-0 pr-5">
                                        <a class="btn btn-info mb-0 me-4" onclick="addForm()">Tambah Kecamatan</a>
                                    </div>

                                <div class="card-body pt-3">
                                    <table class="table" id="datatable-kecamatan">
                                    <thead>
                                        <tr>
                                            <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">No</th>
                                            <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Nama Kecamatan</th>
    ...
    @push('js')
        <script>
                ...
                //delete data
                $('body').on('click', '.hapus-kecamatan', function() {
                    var id = $(this).data("id");
                    if (confirm("Anda Yakin Ingin Menghapus Data Kecamatan?") == true) {
                            $.ajax({
                                type: "DELETE",
                                url: "{{ route('kecamatan.store') }}" + '/' + id,
                ...
                $('#simpan-kecamatan').click(function(e) {
                    ...
                    if (validation(data)) {
                        $.ajax({
                            ...
                            error: function(data) {
                                console.log('Error:', data);
                                $('#simpan-kecamatan').html('Simpan Perubahan');
                            }
                        });
                    }
                ...
                $('body').on('click', '.edit-kecamatan', function() {
                    var id = $(this).data('id');
                    console.log(id);
                    $.get("{{ route('kecamatan.index') }}" + '/' + id + '/edit', function(data) {
                ...
                function addForm() {
                    ...
                    $('#modal-form [nama_kecamatan=nama_kecamatan]').focus();
                }
                ...
                function validation(data) {
                    ...
                    if (!data.nama_kecamatan) {
                        formIsValid = false;
                        $("#error-nama_kecamatan").text('Kolom Nama Kecamatan Wajib diisi.')
                    }
                    return formIsValid;
                }

                function submitHandler() {
                    $('#simpan-kecamatan').click();
                }
        </script>
    @endpush
</x-layout>
